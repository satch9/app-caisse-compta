...
INSERT INTO users (email, password_hash, nom, prenom, is_active) VALUES
('admin@club-tennis.fr', '$2b$10$vZMR99EzwdzPONbJZtAj1uOEooZbyVjH4L2AYey7aQUJ056LWwog2', 'Admin', 'Principal', TRUE);
...
FROM users u
CROSS JOIN roles r
WHERE u.email = 'admin@club-tennis.fr' AND r.code = 'ADMIN';
...
('Boissons fraîches', 'Sodas, jus, eau'),
('Snacks', 'Barres chocolatées, chips, biscuits'),
('Restauration', 'Sandwichs, salades');

-- Produits exemples
INSERT INTO produits (nom, categorie_id, prix_vente, prix_achat, stock_actuel, stock_minimum) VALUES
('Café', 1, 1.50, 0.30, 100, 20),
('Thé', 1, 1.50, 0.25, 80, 20),
('Coca-Cola', 2, 2.50, 1.00, 50, 15),
('Eau minérale', 2, 1.00, 0.40, 100, 30),
('Barre chocolatée', 3, 1.80, 0.80, 60, 20),
('Chips', 3, 2.00, 0.90, 40, 15),
('Sandwich jambon', 4, 4.50, 2.00, 20, 5),
('Salade César', 4, 5.50, 2.50, 15, 5);
